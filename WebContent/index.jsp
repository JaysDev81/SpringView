		...
		<ul>
				...
				<li>
						...
						<li>
								...
								(LacaleChangeController, LocaleResolver 직접 이용 Locale 변환 예제)
								<br />
								링크클릭 후, <a href="<c:url value='/jsp/login/login.do'/>">/jsp/login/login.do</a> 에서 라벨 확인
						</li>
						<li>
								...
								(LacaleChangeInterceptor를 이용한 Locale 변환 예제)
						</li>
				<li>
				...
				<li>
						...
						(viewvm/registeMemberForm.vm, Velocity 예제, #springFormInput 등 폼 관련 매크로)
				</li>
				<li>
						<a href="<c:url value='/vmLayout/login/login.do'/>">/vmLayout/login/login.do</a>
						(viewvmlayout/templete/*, viewvmlayout/loginForm.vm, VelocityLayoutViewResolver 예제) 
				</li>
				...
				<li>
						...
						(PageRanksController 및  PageRanksView 엑셀예제) 
				</li>
				<li>
